...
[ 0] cid                                            INT4                 null: false  primary: true   isArray: false  auto: true   col: INT4            len: -1      default: []
...
[22] customer_id                                    INT4                 null: false  primary: false  isArray: false  auto: false  col: INT4            len: -1      default: []
[23] create_time                                    TIMESTAMP            null: false  primary: false  isArray: false  auto: false  col: TIMESTAMP       len: -1      default: []
[24] modify_time                                    TIMESTAMP            null: false  primary: false  isArray: false  auto: false  col: TIMESTAMP       len: -1      default: []


JSON Sample
-------------------------------------
{    "margin": 36,    "current_reprice_day": "2250-01-15T01:41:21.462020174Z",    "current_rate": 30,    "next_reprice_day": "2136-07-01T04:59:38.474520499Z",    "received_interest": 72,    "customer_id": 50,    "end_date": "2186-09-11T23:48:02.194640085Z",    "lessee": "cIDLocBSWWDPpudJEJaeaDVPx",    "subject_matter": "QSquasfNhJrEWwRSMRBHZCjts",    "current_lpr": 19,    "modify_time": "2250-08-07T02:21:11.125869567Z",    "cid": 92,    "fee": 6,    "actual_principal": 30,    "term_month": 87,    "irr": 36,    "is_lpr": true,    "received_principal": 96,    "is_finished": false,    "abbreviation": "bXVSTbVqSNuegdcGLKaCSsmKD",    "create_time": "2085-05-01T20:06:57.861335084Z",    "start_date": "2138-08-15T17:30:32.878625066Z",    "contract_principal": 35,    "lpr_plus": 91,    "contract_no": "tiOlbRBYajVkdSNDBcVLHoUmQ"}
...
type LeaseContract struct {
	//[ 0] cid                                            INT4                 null: false  primary: true   isArray: false  auto: true   col: INT4            len: -1      default: []
	Cid int32 `gorm:"primary_key;AUTO_INCREMENT;column:cid;type:INT4;" json:"cid" db:"cid"`
	//[ 1] contract_no                                    VARCHAR(255)         null: false  primary: true   isArray: false  auto: false  col: VARCHAR         len: 255     default: []
	ContractNo string `gorm:"primary_key;column:contract_no;type:VARCHAR;size:255;" json:"contract_no" db:"contract_no"`
	//[ 2] lessee                                         VARCHAR(255)         null: false  primary: false  isArray: false  auto: false  col: VARCHAR         len: 255     default: []
	...
	//[ 4] start_date                                     DATE                 null: false  primary: false  isArray: false  auto: false  col: DATE            len: -1      default: []
	StartDate time.Time `gorm:"column:start_date;type:DATE;" json:"start_date" db:"start_date"`
	//[ 5] end_date                                       DATE                 null: false  primary: false  isArray: false  auto: false  col: DATE            len: -1      default: []
	EndDate time.Time `gorm:"column:end_date;type:DATE;" json:"end_date" db:"end_date"`
	//[ 6] fee                                            INT8                 null: false  primary: false  isArray: false  auto: false  col: INT8            len: -1      default: []
	Fee int64 `gorm:"column:fee;type:INT8;" json:"fee" db:"fee"`
	//[ 7] margin                                         INT8                 null: false  primary: false  isArray: false  auto: false  col: INT8            len: -1      default: []
	Margin int64 `gorm:"column:margin;type:INT8;" json:"margin" db:"margin"`
	//[ 8] contract_principal                             INT8                 null: false  primary: false  isArray: false  auto: false  col: INT8            len: -1      default: []
	ContractPrincipal int64 `gorm:"column:contract_principal;type:INT8;" json:"contract_principal" db:"contract_principal"`
	//[ 9] actual_principal                               INT8                 null: false  primary: false  isArray: false  auto: false  col: INT8            len: -1      default: []
	ActualPrincipal int64 `gorm:"column:actual_principal;type:INT8;" json:"actual_principal" db:"actual_principal"`
	//[10] term_month                                     INT2                 null: false  primary: false  isArray: false  auto: false  col: INT2            len: -1      default: []
	TermMonth int32 `gorm:"column:term_month;type:INT2;" json:"term_month" db:"term_month"`
	//[11] subject_matter                                 VARCHAR(255)         null: true   primary: false  isArray: false  auto: false  col: VARCHAR         len: 255     default: []
	SubjectMatter null.String `gorm:"column:subject_matter;type:VARCHAR;size:255;" json:"subject_matter" db:"subject_matter"`
	//[12] irr                                            INT4                 null: true   primary: false  isArray: false  auto: false  col: INT4            len: -1      default: []
	Irr null.Int `gorm:"column:irr;type:INT4;" json:"irr" db:"irr"`
	//[13] is_lpr                                         BOOL                 null: false  primary: false  isArray: false  auto: false  col: BOOL            len: -1      default: []
	IsLpr bool `gorm:"column:is_lpr;type:BOOL;" json:"is_lpr" db:"is_lpr"`
	//[14] current_reprice_day                            DATE                 null: true   primary: false  isArray: false  auto: false  col: DATE            len: -1      default: []
	...
	//[17] current_rate                                   INT4                 null: true   primary: false  isArray: false  auto: false  col: INT4            len: -1      default: []
	CurrentRate null.Int `gorm:"column:current_rate;type:INT4;" json:"current_rate" db:"current_rate"`
	//[18] next_reprice_day                               DATE                 null: true   primary: false  isArray: false  auto: false  col: DATE            len: -1      default: []
	NextRepriceDay null.Time `gorm:"column:next_reprice_day;type:DATE;" json:"next_reprice_day" db:"next_reprice_day"`
	//[19] received_principal                             INT8                 null: true   primary: false  isArray: false  auto: false  col: INT8            len: -1      default: []
	ReceivedPrincipal null.Int `gorm:"column:received_principal;type:INT8;" json:"received_principal" db:"received_principal"`
	//[20] received_interest                              INT8                 null: true   primary: false  isArray: false  auto: false  col: INT8            len: -1      default: []
	ReceivedInterest null.Int `gorm:"column:received_interest;type:INT8;" json:"received_interest" db:"received_interest"`
	//[21] is_finished                                    BOOL                 null: false  primary: false  isArray: false  auto: false  col: BOOL            len: -1      default: []
	IsFinished bool `gorm:"column:is_finished;type:BOOL;" json:"is_finished" db:"is_finished"`
	//[22] customer_id                                    INT4                 null: false  primary: false  isArray: false  auto: false  col: INT4            len: -1      default: []
	CustomerID int32 `gorm:"column:customer_id;type:INT4;" json:"customer_id" db:"customer_id"`
	//[23] create_time                                    TIMESTAMP            null: false  primary: false  isArray: false  auto: false  col: TIMESTAMP       len: -1      default: []
