...
func (model *BankRepayPlanCalcModel) hzRowIns(vals map[interface{}]interface{}, upperVals map[interface{}]interface{}) int64 {
	...
	accruedB := big.NewInt(vals["plan_principal"].(int64))
